        ...
        switch (op[0]) {
            ...
            case 8:
                ...
                if (this.cssC) {
                    ...
                    this.cursors[hdr[0]] = (this.msie > 0 || this.trident > 0) ? { u: '/cur/' + this.sid + '/' + hdr[0] } : { u: '/cur/' + this.sid + '/' + hdr[0], x: hdr[1], y: hdr[2] };
                }
                break;
            case 9:
                // PTR_FREE
            ...
            case 'string':
                ...
                switch (evt.data.substr(0, 2)) {
                    ...
                    case 'R:':
                        ...
                        // console.log('resolution changed to ' + resolution[0] + 'x' + resolution[1]);
